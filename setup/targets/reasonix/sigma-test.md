...
Runs a comprehensive read-only health check of the Sigma ecosystem installation for the current AI platform (Reasonix). Checks are grouped into four categories. Each check reports PASS, WARN, or FAIL.
