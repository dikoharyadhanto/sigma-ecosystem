...
Runs a comprehensive read-only health check of the Sigma ecosystem installation for the current AI platform (Claude Code). Checks are grouped into five categories. Each check reports PASS, WARN, or FAIL.
