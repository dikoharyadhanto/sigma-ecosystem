...
> "Next step: tell me what you want to build, and I'll draft an Intent Doc capturing the objective, scope, and constraints. (That's ARC's job — later phases use different roles.)"
...
> "To move forward, we need to lock down what you're building and why — that becomes the Intent Doc (DIR-INTENT)."
