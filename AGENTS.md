---
name: CODEX-RULES
description: System-level constraints for Codex operating in the sigma-ecosystem project
---

# Codex Model Directives — sigma-ecosystem

## Ownership

These rules apply strictly to the Codex model operating in this project.
