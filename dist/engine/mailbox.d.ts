...
export declare function generateMessageId(from: SigmaRole, to: SigmaRole, ts: string): string;
export declare function generateFilename(type: MessageType, from: SigmaRole, to: SigmaRole, ts: string): string;
