...
exports.registerCreateExecDraftTool = registerCreateExecDraftTool;
const zod_1 = require("zod");
const execDraftService_1 = require("../../../services/execDraftService");
const shared_1 = require("../shared");
function registerCreateExecDraftTool(server) {
    server.registerTool('sigma_create_exec_draft', {
        title: 'Create DEV-EXEC draft',
        description: 'Creates a new DEV-EXEC DRAFT for a LOCKED FMN-PLAN — the MCP control-plane equivalent of `sigma exec ' +
        ...
        transactionFiles: (root) => (0, execDraftService_1.createExecDraftTransactionFiles)(root, args.plan_version),
    }, 
    ...
    (root) => (0, execDraftService_1.createExecDraft)({
        projectRoot: root,
        planVersion: args.plan_version,
    })));
}
//# sourceMappingURL=createExecDraft.js.map