...
exports.registerCommitExecLockTool = registerCommitExecLockTool;
    ...
    server.registerTool('sigma_commit_exec_lock', {
        ...
        return (0, shared_2.respondControlWrite)({
            ...
            transactionFiles: (root) => [
                ...(0, execLockService_1.lockExecDraftTransactionFiles)(root),
            ...
            checkPreconditions: (root) => {
                ...
                if (ticket.operation_id !== 'exec_lock') {
                    throw new errors_1.McpQueryError(contract_1.ERROR_CODES.INVALID_OPERATION, 'That ticket is not an exec_lock ticket.');
                }
                ...
                if (!ticket.target || !execEntry || execEntry.state !== 'DRAFT' || !execEntry.file) {
                    throw new errors_1.McpQueryError(contract_1.ERROR_CODES.STALE_ARTIFACT, "The target DEV-EXEC no longer matches this ticket's target.");
                }
                const doc = (0, artifactPath_1.readCanonicalArtifactFile)(root, 'exec', execEntry.version, execEntry.file);
            ...
            const result = (0, execLockService_1.lockExecDraftUseCase)(root, verifiedTargetVersion);
            const consumedAt = new Date().toISOString();
            (0, controlStore_1.markTicketConsumed)(root, args.operation_ticket_id, consumedAt);
            (0, controlStore_1.controlTestFailpoint)('exec_lock_after_ticket_consumed');
            (0, controlStore_1.markApprovalConsumed)(root, args.approval_id, consumedAt);
            (0, controlStore_1.controlTestFailpoint)('exec_lock_after_approval_consumed');
            return {
...
//# sourceMappingURL=commitExecLock.js.map