...
exports.registerCommitIntentSupersedeTool = registerCommitIntentSupersedeTool;
...
function registerCommitIntentSupersedeTool(server) {
    server.registerTool('sigma_commit_intent_supersede', {
        title: 'Commit an approved intent supersede',
        description: 'Supersedes the active chain\'s RATIFIED DIR-INTENT frozen by operation_ticket_id, cascading ' +
        ...
        return (0, shared_2.respondControlWrite)({
            ...
            transactionFiles: (root) => [
                ...(0, intentSupersedeService_1.intentSupersedeTransactionFiles)(root),
            ...
            checkPreconditions: (root) => {
                ...
                if (ticket.operation_id !== 'intent_supersede') {
                    throw new errors_1.McpQueryError(contract_1.ERROR_CODES.INVALID_OPERATION, 'That ticket is not an intent_supersede ticket.');
                }
            ...
            const result = (0, intentSupersedeService_1.supersedeIntentUseCase)(root, args.reason);
            const consumedAt = new Date().toISOString();
            (0, controlStore_1.markTicketConsumed)(root, args.operation_ticket_id, consumedAt);
            (0, controlStore_1.controlTestFailpoint)('intent_supersede_after_ticket_consumed');
            (0, controlStore_1.markApprovalConsumed)(root, args.approval_id, consumedAt);
            (0, controlStore_1.controlTestFailpoint)('intent_supersede_after_approval_consumed');
            return {
...
//# sourceMappingURL=commitIntentSupersede.js.map